...
if (temperature >= 80 && rain === true){
  console.log(`today is a great day for a t-shirt but you might want to take an umbrella just in case`)
} else if (temperature > 60 && temperature < 80 && rain === true) {
  console.log(`today I would recommend a rain jacket`)
  ...
  console.log(`today is t shirt weather!`)
} else if (temperature > 60 && temperature < 80 && rain === false) {
  console.log(`i'd recommend a light jacket incase it gets cold`)
} else if (temperature <= 60 && rain === false) {
  console.log(`id recommend a winter coat its freezing!`)
} 
////////// PROBLEM 5 //////////
...
let changeMyMind = true
 if (changeMyMind === true) {
  changeMyMind = false
  console.log(`I've changed your mind to ${changeMyMind}`)
 } else {
  changeMyMind = true 
  console.log(`your mind is changed to true`)
 }
////////// PROBLEM 10 //////////
...
if (changeMyMind !== true) {
  ...
  console.log(`i've changed your mind to true!`)
 }
////////// ADVANCED PROBLEMS //////////
